...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Music Finder CNX</title>

    <!-- Bootstrap Core CSS -->
    <link href="./theme_files/bootstrap.min.css" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="./theme_files/freelancer.min.css" rel="stylesheet">
...
<body id="page-top" class="index">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolio">Portfolio</a>
                    </li>
                    <li class="page-scroll">
                        <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#about">About</a>
                    </li>
                    <li class="page-scroll">
                        <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#contact">Contact</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="row">
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="./theme_files/cake.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="./theme_files/circus.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="./theme_files/game.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="./theme_files/safe.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="https://blackrockdigital.github.io/startbootstrap-freelancer/#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="./theme_files/submarine.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="./theme_files/cake.png" class="img-responsive img-centered" alt="">
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download their free set with 16 icons, or you can purchase the entire set with 146 icons for only $12!</p>
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://startbootstrap.com/">Start Bootstrap</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="./theme_files/circus.png" class="img-responsive img-centered" alt="">
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download their free set with 16 icons, or you can purchase the entire set with 146 icons for only $12!</p>
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://startbootstrap.com/">Start Bootstrap</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="./theme_files/game.png" class="img-responsive img-centered" alt="">
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download their free set with 16 icons, or you can purchase the entire set with 146 icons for only $12!</p>
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://startbootstrap.com/">Start Bootstrap</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="./theme_files/safe.png" class="img-responsive img-centered" alt="">
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download their free set with 16 icons, or you can purchase the entire set with 146 icons for only $12!</p>
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://startbootstrap.com/">Start Bootstrap</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            <h2>Project Title</h2>
                            <hr class="star-primary">
                            <img src="./theme_files/submarine.png" class="img-responsive img-centered" alt="">
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download their free set with 16 icons, or you can purchase the entire set with 146 icons for only $12!</p>
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://startbootstrap.com/">Start Bootstrap</a>
    ...
    <!-- jQuery -->
    <script src="./theme_files/jquery.min.js.download"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="./theme_files/bootstrap.min.js.download"></script>

    <!-- Plugin JavaScript -->
    <script src="./theme_files/jquery.easing.min.js.download"></script>

    <!-- Contact Form JavaScript -->
    <script src="./theme_files/jqBootstrapValidation.js.download"></script>
    <script src="./theme_files/contact_me.js.download"></script>
