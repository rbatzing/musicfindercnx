...
<body ng-app="MusicFinder" id="page-top" class="index">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Music Finder CNX</span>
                        <hr class="star-light">
                        <span class="skills">Explore Boundary - Explore Mood - Make A Deeper Worship</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="portfolio">
        <div class="container">
            ...
            <div class="row">
                <img src="./theme_files/logo.png" class="img-responsive center-block" alt=""
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="text-center">
                    <p>This is the project for indigitious hackerthon on Music Finder.</p>
                </div>
                <!-- <div class="col-lg-4">
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        This website is powered by Freelancer Theme
                    </div>
                </div>
            </div>
        </div>
